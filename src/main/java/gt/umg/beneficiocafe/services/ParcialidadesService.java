...
public class ParcialidadesService {
    ...
    public ParcialidadesService(ParcialidadesRepository parcialidadesRepository, JwtUtils jwtUtils, SolicitudesRepository solicitudesRepository) {
    ...
    public ResponseEntity<?> enviarParcialidad(CrearParcialidadesRequest parcialidad) throws BadRequestException{
        ...
        try{
            ...
            if (solicitud == null) {
                ...
                BCParcialidades nuevaParcialidad = new BCParcialidades(parcialidad.getSolicitud(), parcialidad.getPesoEnviado(), parcialidad.getPlaca(), parcialidad.getPiloto(), parcialidad.getUsuarioCreacion(), ManejoFechas.setTimeZoneDateGT(new Date()));
