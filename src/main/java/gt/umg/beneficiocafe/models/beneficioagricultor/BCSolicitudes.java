...
public class BCSolicitudes {
    ...
    public BCSolicitudes(UUID estadoSolicitud, String placa, Integer cantidadParcialidades, String piloto, UUID usuarioCreacion, Date fechaCreacion,Integer totalPesaje) {
